...
class MakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create make" do
    assert_difference('Make.count') do
      post makes_url, params: { make: { car_id: @make.car_id, country: @make.country, name: @make.name } }
    end
  ...
  test "should update make" do
    patch make_url(@make), params: { make: { car_id: @make.car_id, country: @make.country, name: @make.name } }
